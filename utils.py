...
def launch_driver(driver_name=settings.DRIVER, desired_capabilities=None):
    ...
    if driver_name == 'Remote':
        ...
        if browser == 'firefox':
            ...
            # If you want to override the user agent, use 'moz:firefoxOptions'
            # desired_capabilities['moz:firefoxOptions'] = {'prefs': {'general.useragent.override': 'OSF Selenium Bot'}}
            ...
            desired_capabilities['os'] = 'Windows'
            desired_capabilities['osVersion'] = '11'
            # If you want to override the user agent, use chromeOptions args
            # chrome_options.add_argument('user-agent=OSF Selenium Bot')
            # desired_capabilities['goog:chromeOptions'] = {'args': chrome_options.arguments}
            driver = webdriver.Remote(
                command_executor=command_executor,
                desired_capabilities=desired_capabilities,
